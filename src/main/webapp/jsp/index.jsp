...
<link rel="stylesheet" href="${path}/css/myPageMain.css?after"/>
			  ...
			  if(event.keyCode == 13) {  
					 $.ajax({
						 ...
						 success:function(responseData){
							 ...
							 $("#ajax_research").html(responseData);
						 }
					 });
			  }
		  });
...
<!-- 글 작성 버튼 -->
	<span id="insertBtn"><img src="${path}/img/header/insertBtn.png" alt="insert"></span>
<!-- WRAP -->	
	<div id="wrap">
<!-- HEADER -->
		<header>
			<div id="header_wrap">
				...
				<div id="header_right">
					...
					<p id="btn_mypage"><img src="${path}/img/header/mypage.png" alt="mypage">마이페이지</p> 
		...
		<footer>
                <div id="footer_wrap">
                    ...
                    <div id="footer_bottom">
                    	<a href="index"><img src="${path}/img/header/logo.png" alt="N분의1"></a>
